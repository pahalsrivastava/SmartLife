            ...
            <CardContent>
              <Stack spacing={2}>
                <Stack direction="row" spacing={1} alignItems="center">
                  ...
                  <Typography variant="h6" fontWeight={700}>Smart Financial Intelligence</Typography>
                </Stack>
                <Typography color="text.secondary" align='center'>
                  SmartLife turns your data into real insight — from AI detecting that 30% of your money goes to coffee, to predictive budgeting that shows where you're headed next
                </Typography>
              </Stack>
            </CardContent>
          </Card>
            ...
            <CardContent>
              <Stack spacing={2}>
                <Stack direction="row" spacing={1} alignItems="center">
                  ...
                  <Typography variant="h6" fontWeight={700}> Better Habits = rewards </Typography>
                </Stack>
                <Typography color="text.secondary">
                  Turn progress into motivation. SmartLife connects your habits with real-world impact — like saving on healthcare when you hit your gym goals. Earn badges, unlock rewards, and watch your streaks grow with every milestone.
                </Typography>
              </Stack>
            </CardContent>
          </Card>
            ...
            <CardContent>
              <Stack spacing={2}>
                <Stack direction="row" spacing={1} alignItems="center">
                  ...
                  <Typography variant="h6" fontWeight={700}>Social & Community </Typography>
                </Stack>
                <Typography color="text.secondary">Join a community that thrives on progress — compare routines with friends, take part in weekly challenges, and celebrate achievements together. Get actionable insights with clean charts and reports that highlight what matters.
                </Typography>
              </Stack>
            </CardContent>
          </Card>
      ...
      <Box sx={{ py: 6 }}>
        <Container maxWidth="lg">
          <Stack direction={{ xs: 'column', sm: 'row' }} alignItems="center" justifyContent="space-between" spacing={2}>
            <Typography variant="body2" color="text.secondary"> SmartLife by Pahal Srivastava :D</Typography>
          </Stack>
        </Container>
      </Box>
    </Box>
