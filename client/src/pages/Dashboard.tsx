        ...
        <Grid item={true} xs={12} md={4}>
          <Card sx={{p:3, minWidth:350, maxWidth:500, height:"100%",boxShadow:4, borderRadius:3}}>
            <CardContent>
              ...
              <Typography variant="h3" mt={1} marginLeft={12} marginTop={10}>
                {habitsDoneToday}/{habits.length}
              </Typography>
              <Typography color="text.secondary" marginLeft={9} marginTop={5}>Daily consistency</Typography>
            </CardContent>
          </Card>
        </Grid>
        <Grid item xs={12} md={4}>
          <Card sx={{p:3, minWidth:350, maxWidth:500, height:"100%",boxShadow:4, borderRadius:3}}>
            <CardContent marginTop={2}>
              <Stack direction="row" justifyContent="space-between" alignItems="center" sx={{mb:5 }}>
                <Typography variant="h6" padding={2}>Weekly Progress</Typography>
